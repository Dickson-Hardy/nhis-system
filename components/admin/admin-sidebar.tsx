...
const navigation = [
  { name: "Dashboard", href: "/admin", icon: Home, description: "System overview" },
  { name: "Users", href: "/admin/users", icon: Users, description: "User management" },
  { name: "TPAs", href: "/admin/tpas", icon: Building, description: "Third party admins" },
  { name: "Facilities", href: "/admin/facilities", icon: Building, description: "Healthcare facilities" },
  { name: "Claims", href: "/admin/claims", icon: FileText, description: "Claims processing" },
  { name: "Financial", href: "/admin/financial", icon: DollarSign, description: "Financial overview" },
  { name: "Payments", href: "/admin/payments", icon: BarChart3, description: "Payment tracking" },
  { name: "Analytics", href: "/admin/analytics", icon: Activity, description: "Data insights" },
  { name: "Error Logs", href: "/admin/error-logs", icon: AlertTriangle, description: "System errors" },
